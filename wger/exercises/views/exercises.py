...
class ExerciseCorrectView(ExercisesEditAddView, LoginRequiredMixin,
    ...
    messages = _('Thank you. Once the changes are reviewed the\
    ...
    def form_valid(self, form):
        ...
        site administrators. We don't return the super().form_valid because
        we don't want the data to be saved.
        '''
...
class ExerciseDeleteView(WgerDeleteMixin,
    ...
    delete_message = ugettext_lazy('This will delete the exercise from\
    all workouts.')
...
def accept(request, pk):
    ...
    messages.success(request, _('Exercise was successfully added to the\
    general database'))
