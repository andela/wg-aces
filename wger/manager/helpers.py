...
def render_workout_day(day, nr_of_weeks=7, images=False, comments=False,
    ...
    for marker in group_exercise_marker:
        ...
        table_style.append(('VALIGN', (0, start_marker),
                            (0, end_marker), 'MIDDLE'))
...
class WorkoutCalendar(HTMLCalendar):
    ...
    * http://uggedal.com/journal/creating-a-flexible-monthly-calendar-in-django/ # noqa E501
    '''
    ...
    def day_cell(self, cssclass, body):
        ...
        Renders a day cell
        '''
        return '<td class="{0}" style="vertical-align:\
        middle;">{1}</td>'.format(cssclass, body)
