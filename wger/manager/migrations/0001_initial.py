    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(
                    help_text='Ususally a description about what parts are\
                    trained, like "Arms" or "Pull Day"',
                    max_length=100, verbose_name='Description')),
                ('day', models.ManyToManyField(to='core.DaysOfWeek',
                                               verbose_name='Day')),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(
                    default=True,
                    help_text='Tick the box if you want to mark this schedule\
                    as your active one (will be shown e.g. on your dashboard).\
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(default=1, max_length=1,
                                              verbose_name='Order')),
                ('schedule', models.ForeignKey(verbose_name='schedule',
                                               to='manager.Schedule')),
            ],
            options={
                'ordering': ['order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sets', models.IntegerField(
                    default=4, verbose_name='Number of sets',
                    validators=[
                        django.core.validators.MinValueValidator(0),
                        django.core.validators.MaxValueValidator(10)])),
                ('exerciseday', models.ForeignKey(verbose_name='Exercise day',
                                                  to='manager.Day')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(max_length=100,
                                             ...
                                             blank=True)),
                ('exercise', models.ForeignKey(verbose_name='Exercises',
                                               to='exercises.Exercise')),
                ('set', models.ForeignKey(verbose_name='Sets',
                                          to='manager.Set')),
            ],
            options={
                'ordering': ['order', 'id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(editable=False,
                                           to=settings.AUTH_USER_MODEL,
                                           verbose_name='User')),
                ('workout', models.ForeignKey(verbose_name='Workout',
                                              to='manager.Workout')),
            ],
            options={
                'ordering': ['date', 'reps'],
        ...
        migrations.AddField(
            model_name='day',
            name='training',
            field=models.ForeignKey(verbose_name='Workout',
                                    to='manager.Workout'),
            preserve_default=True,
        ),
    ]
