...
class NutritionPlan(models.Model):
    ...
    def get_calories_approximation(self):
        ...
        # Within 3%
        if (actual_calories < goal_calories * 1.03)\
                and (actual_calories > goal_calories * 0.97):
            return 1
        # within 7%
        elif (actual_calories < goal_calories * 1.07)\
                and (actual_calories > goal_calories * 0.93):
            return 2
        # within 10%
        elif (actual_calories < goal_calories * 1.10)\
                and (actual_calories > goal_calories * 0.9):
            return 3
        # even more
        else:
            return 4
