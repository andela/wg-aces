    ...
    operations = [
        migrations.AddField(
            ...
            field=models.IntegerField(
                ...
                help_text='Number of days after the last weight entry\
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                ...
                default=False,
                help_text='Allow external users to access your workouts and\
                ogs in a read-only mode. You need to set this before you can\
                share links e.g. to social media.'),
            preserve_default=True,
        ),
    ]
