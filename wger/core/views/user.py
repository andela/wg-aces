...
def trainer_login(request, user_pk):
    ...
    # - https://docs.djangoproject.com/en/1.6/topics/auth/default/#auth-web-requests # noqa E501
    # - http://stackoverflow.com/questions/3807777/django-login-without-authenticating # noqa E501
    if own:
